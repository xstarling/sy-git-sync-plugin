...
#### 当前版本更新
  1. 删除思源笔记导出markdown文件时会默认添加title
  2. 新增刷新工作树按钮，手动点击触发刷新工作树,避免每次同步完成刷新工作树，导致系统重启
  3. 优化同步插件的错误提示信息,已经日志记录问题
  4. 修复同步时，修改笔记格式，导致远端数据为空
  5. 优化设置界面，设计兼容云盘和git平台同步（具体数据同步还在开发中）
...
+ **🚧功能菜单**
  + 🚀开始同步：启动本地与远端的数据同步
  + 🚀刷新工作树：若同步后，本地新增的文件出现【ID未找到！】的问题，可以通过刷新工作树解决
  + 🚀同步范围：
